...
export declare const getSuccessFailureActionlogCountsByYear: (req: Request, res: Response) => Promise<void>;
export declare const getSuccessFailureActionlogCountsByPlatformAndYear: (req: Request, res: Response) => Promise<void>;
export declare const getSuccessFailureActionlogCountsByAllocationTypeAndYear: (req: Request, res: Response) => Promise<void>;
