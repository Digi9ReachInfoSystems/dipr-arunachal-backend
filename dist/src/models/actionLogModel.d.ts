...
export default class ActionLog {
    ...
    constructor({ user_ref, islogin, rodocref, ronumber, docrefinvoice, email, old_data, edited_data, user_role, action, message, status, actiontime, platform, networkip, screen, Newspaper_allocation, }: ActionLogProps);
}
